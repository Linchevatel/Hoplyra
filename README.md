...
| Platform | Download |
|---|---|
| **Linux x86_64** | [AppImage](https://github.com/Linchevatel/Hoplyra/releases/download/v1.3.4/Hoplyra-1.3.4-x86_64.AppImage) |
| **Windows x64** | [portable exe](https://github.com/Linchevatel/Hoplyra/releases/download/v1.3.4/Hoplyra-1.3.4-x64-portable.exe) |
...
chmod +x Hoplyra-1.3.4-x86_64.AppImage
./Hoplyra-1.3.4-x86_64.AppImage
```

Windows: run `Hoplyra-1.3.4-x64-portable.exe` (portable, no installer).
