...
| Platform | Download |
|---|---|
| **Linux x86_64** | [AppImage](https://github.com/Linchevatel/Hoplyra/releases/download/v1.4.0/Hoplyra-1.4.0-x86_64.AppImage) |
| **Windows x64** | [portable exe](https://github.com/Linchevatel/Hoplyra/releases/download/v1.4.0/Hoplyra-1.4.0-x64-portable.exe) |
...
chmod +x Hoplyra-1.4.0-x86_64.AppImage
./Hoplyra-1.4.0-x86_64.AppImage
```

Windows: run `Hoplyra-1.4.0-x64-portable.exe` (portable, no installer).
